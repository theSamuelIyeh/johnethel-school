    ...
    html! {
      <div class="flex items-center justify-center w-full h-screen">
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
              ...
              <div class="w-full flex items-center justify-center bg-lime-400 py-4 rounded-md">
                {svgs::logo()}
              </div>
                <div class="text-center mx-20 mt-4">
                  <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">"Sign in"</h1>
                  <p class="mt-3 text-sm text-gray-600 dark:text-neutral-400">
                    "Go back home?"
                    <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500 ml-2" href="/" hx-boost="true">
                    "Click Here"
                    </a>
                  </p>
                </div>
                ...
                <div class="mt-5">
                //   <button type="button" class="w-full py-3 px-10 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                ...
                <form>
                  ...
                  <div>
                    <div class="flex justify-between items-center">
                      ...
                      <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium" href="/forgot-password" hx-boost="true">"Forgot password?"</a>
                    </div>
                    <div class="relative">
              ...
              <button class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" hx-post="/login">"Sign in"</button>
            </div>
          </form>
          // End Form
        </div>
