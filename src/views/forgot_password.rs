...
pub fn forgot_password() -> String {
    html! {
      ...
      <div class="w-full flex items-center justify-center bg-lime-400 py-4 rounded-md">
        ...
        <div class="text-center mx-10 mt-4">
          <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">"Forgot password?"</h1>
          <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
            "Remember your password?"
            <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500 ml-2" href="/login">
              "Sign in here"
            </a>
          </p>
        </div>
